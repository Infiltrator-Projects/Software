...
void ThemeController::apply()
{
    ...
    css
        ...
        << ".window-control { margin: 3px 1px; min-width: 34px; padding: 0 7px; "
        << "background: " << button_bg << "; border: 1px solid " << border << "; }"
        << ".window-control:hover { background: " << neutral << "; }"
        << ".window-close-control:hover { background: " << fault << "; }"
        << ".window-close-control:hover image { color: #ffffff; }"
        << ".titlebar-window-separator { margin: 8px 6px; background: " << border << "; }"
        ...
        << ".discover-welcome { min-height: 184px; background: #07102d; "
        ...
        << ".welcome-content { background: transparent; }"
        << ".welcome-kicker { font-size: 9px; font-weight: "
        << typography->ui_bold_weight << "; color: #a9c9ff; letter-spacing: 0.5px; }"
        << ".welcome-title, .welcome-title-accent { font-family: \"" << typography->ui_family
        << "\"; font-size: 33px; font-weight: " << typography->ui_bold_weight << "; }"
        << ".welcome-title { color: #ffffff; }"
        << ".welcome-title-accent { color: #8e63ff; }"
        << ".welcome-subtitle { font-size: 12px; color: #d9e3ff; }"
